...
class ParentAgent():
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ParentAgent):
            return False
        return self.compare(other)
    
    def compare(self, other: Union['ParentAgent', None]) -> bool:
        """
    ...
    def satisfaction_perc(self, agent_list: List[Union['ParentAgent', None]]) -> bool:
        same_group_count = 0
        other_group_count = 0
    ...
    def is_satisfied(self, agent_list: List[Union['ParentAgent', None]]) -> bool:
        """
